...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "riri.globalredirector/riri.globalredirector.csproj",
    $PackageName = "riri.globalredirector",
    ...
    $NuGetPackageId = "riri.globalredirector",
...
# Publish interface
$InterfaceProjectPath = "riri.globalredirector.Interfaces/riri.globalredirector.Interfaces.csproj"
